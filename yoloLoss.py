...
class YoloLoss(nn.Module):
    ...
    def forward(self, pred_tensor, target_tensor):
        ...
        noobj_target_mask = noobj_target_mask.bool()
        ...
        noobj_loss = functional.mse_loss(noobj_pred_c, noobj_target_c, reduction='sum')
        ...
        contain_loss = functional.mse_loss(box_pred_response[:, 4], box_target_response[:, 4], reduction='sum')
        loc_loss = functional.mse_loss(box_pred_response[:, :2], box_target_response[:, :2], reduction='sum') + \
                   functional.mse_loss(box_pred_response[:, 2:4], box_target_response[:, 2:4], reduction='sum')
        # 2. not response loss
        ...
        class_loss = functional.mse_loss(class_pred, class_target, reduction='sum')
